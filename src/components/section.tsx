...
export function Section(props: SectionProps) {
  ...
  return (
    <div
      className={clsx(
        "border-b border-neutral-950 last:border-b-0 border-opacity-10 dark:border-gray-300",
        containerClassName
      )}
    >
      <div
        className={clsx(
          "w-full max-w-screen-sm mx-auto border-x border-neutral-950 border-opacity-10 box-content px-8 dark:border-gray-300",
          contentClassName
        )}
      >
        {children}
