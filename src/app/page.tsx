    ...
    <>
      ...
      <FadeIn>
        <Section contentClassName="py-32 flex gap-3 flex-col">
          ...
          <p>
            I’m Christian, a front-end developer and UI designer from Denmark
            with a passion for problem-solving and everything tech and AI. I
            thrive on continuous learning and aim to be at least 1% better every
            day.
          </p>
          <p>
      ...
      <Section>
        ...
        <FadeIn>
          <BubbleSection index={1}>
            ...
            <p className="text-lg text-center text-neutral-600 dark:text-neutral-300 font-normal">
              I started studying Multimedia design, where I started with
              learning HTML, CSS, and then JS. Ended up using the framework Vue.
            </p>
          </BubbleSection>
        </FadeIn>
        <FadeIn>
          <BubbleSection index={2} contentClassName="mb-10">
            ...
            <p className="text-lg text-center text-neutral-600 dark:text-neutral-300 font-normal">
              I initially focused on Vue for school work, but I became
              interested in learning other tools like React and TypeScript.
              Tailwind CSS quickly became my go-to for efficiently styling
              modern interfaces.
            </p>
          </BubbleSection>
        </FadeIn>
